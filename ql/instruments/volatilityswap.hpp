...
#ifndef quantlib_volatility_swap_hpp
#define quantlib_volatility_swap_hpp
...
namespace QuantLib {
    ...
    /*! \warning This class does not manage seasoned variance swaps.
        ...
        \ingroup instruments
    */
    /*QuantLib::VolatilitySwap::VolatilitySwap(Position::Type position, Real strike, Real notional,
const Date & startDate, const Date & maturityDate)
{
    ...
    class VolatilitySwap : public VarianceSwap {
        ...
        //  class results;
        //  class engine;
        VolatilitySwap(Position::Type position,
                       Real strike,
                       Real notional,
        ...
        : VarianceSwap(position,
					   ...
					   fixingDates, 
					   daysPerYear,
					   VarSwapType::Type::Vanilla,
                       VarSwapBarrierConvention::Type::N){};
